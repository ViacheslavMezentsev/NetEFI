...
{
    /// <summary>
    /// A non-generic base class used by the host to identify all function types.
    /// It implements the internal IComputable interface.
    /// </summary>
    ...
    public abstract class CustomFunctionBase
    {
        ...
        [EditorBrowsable( EditorBrowsableState.Never )]
        public FunctionInfo GetFunctionInfo( string lang ) => this.Info;
    ...
    public abstract class CustomFunction<TArg1, TResult>: CustomFunctionBase
    {
        /// <summary>
        ...
        /// <summary>
        /// This method is sealed and hidden from IntelliSense.
        /// It handles the type casting and error wrapping for the user.
        /// </summary>
        [EditorBrowsable( EditorBrowsableState.Never )]
        public sealed override bool NumericEvaluation( object[] args, out object result, Context context )
        {
            ...
            {
                result = new ErrorResult( ex.ErrorKey, ex.ArgNum );
                return true;
            }
            catch ( Exception ex )
            {
                var errorAttr = GetType().GetCustomAttributes<ErrorAttribute>()
                    .FirstOrDefault( a => a.Key.Equals( ex.Message, StringComparison.Ordinal ) );

                if ( errorAttr != null )
                {
                    // If the exception message matches a defined error key, convert it to a custom error.
                    result = new ErrorResult( errorAttr.Key, 0 ); // 0 for general error
                }
                else
                {
                    // Otherwise, let the exception bubble up to the host to be logged as critical.
                    throw;
                }
                return true;
            }
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
    ...
    /// </summary>
    public abstract class CustomFunction<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10, TResult>: CustomFunctionBase
    {
        /// <summary>
        /// Implement your function's logic here.
        /// </summary>
